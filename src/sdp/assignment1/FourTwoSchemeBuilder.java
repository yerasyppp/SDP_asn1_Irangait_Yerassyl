...
public class FourTwoSchemeBuilder implements LineupBuilder {
    ...
    public VolleyballLineup build() {
        ...
        // 4-2 specific domain validation
        if (setterCount != 2 || oppositeCount != 0) {
            throw new IllegalStateException("A 4-2 scheme must have exactly 2 setters and 0 opposites.");
        }
